document.addEventListener('DOMContentLoaded', () => {
    ...
    const firstHeadingAnimation = animateText("#heading1", 3.5, 0.2); // Set duration to 1 second for faster animation

    // Animation for the second heading with a delay of 1 second
    const secondHeadingAnimation = animateText("#heading2", 4.5, "auto"); // Let the duration be automatically calculated based on characters
